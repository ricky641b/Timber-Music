...
public class SettingsFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    ListPreference themePreference, startPagePreference, shakeActionPreference, shakeThresholdPreference;
...
//        themePreference = (ListPreference) findPreference(KEY_THEME);
        ...
        shakeActionPreference = (ListPreference) findPreference(SHAKE_ACTION_PREFERENCE);
        shakeThresholdPreference = (ListPreference) findPreference(SHAKE_THRESHOLD_PREFERENCE);
...
//        });
        ...
        shakeThresholdPreference.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                mPreferences.setShakeThresholdPreference((String) newValue);

                return true;
            }
        });

        shakeActionPreference.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            @Override
            public boolean onPreferenceChange(Preference preference, Object newValue) {

                mPreferences.setShakeActionPreference((String) newValue);
